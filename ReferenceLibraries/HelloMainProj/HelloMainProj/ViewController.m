...
- (void)viewDidLoad {
    [super viewDidLoad];
    // Hello Library 裡的方法
    NSString *greeting = [HelloLibrary helloFunc];
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"試用權限" message:greeting delegate:self cancelButtonTitle:@"確定" otherButtonTitles:nil, nil];
